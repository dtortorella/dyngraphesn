README for dataset infectious_ct2
...
Based on a data sets from the SocioPatterns project (http://www.sociopatterns.org). 
The Infectious graph represents face-to-face contacts between visitors of the exhibition Infectious: Stay Away [2].
...
This dataset is for the classification task 2 described in [1].
...
[2] L. Isella, J. Stehlé, A. Barrat, C. Cattuto, J.-F. Pinton, and W. Van den Broeck.
    What’s in a crowd? Analysis of face-to-face behavioral networks. 
    Journal of Theoretical Biology, 271(1):166–180, 2011.

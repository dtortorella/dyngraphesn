...
We used a subset of the DBLP database (https://dblp.uni-trier.de/) to generate temporal co-author graphs. 
The subset was chosen by considering publications in proceedings of selected machine learning conferences. 
The time stamp of an edge is the year of the joint publication. 
